...
library("xlsx")
library("writexl")
write.xlsx(Cancer2, file, sheetName = "Sheet1", col.names = TRUE,
           row.names = TRUE, append = FALSE, showNA = TRUE, password = NULL)
write.csv(Cancer2, "C:/Users/music/Desktop/CancerRecoded.csv")
write.xlsx(Cancer2, "C:/Users/music/Desktop/CancerRecoded.xlsx")